...
const GlassDock = React.forwardRef<HTMLDivElement, GlassDockProps>(
  (
    ...
    const getScale = React.useCallback(
      (index: number) => {
        // TAMBAHKAN INI: Jika di mobile/layar sentuh, jangan hitung scale (tetap 1)
        if (
          mousePos === null ||
      ...
      <div ref={ref} className={cn("relative", className)} {...props}>
        <div
          className={cn(
            ...
            "bg-linear-to-r from-[#a79dda]/30 via-[#514575]/25 to-[#201d39]/30",
            ...
            const DockItemContent = (
              ...
              >
                ...
                >
                  ...
                  {/* Active glow */}
                  {item.active && (
                    <div className="absolute -inset-1.5 rounded-2xl bg-linear-to-r from-[#a79dda]/50 to-[#514575]/50 blur-md -z-10" />
                  )}
                ...
                {item.active && (
                  <div
                    className={cn(
                      ...
                      "bg-linear-to-r from-[#a79dda] to-[#514575]",
                      "shadow-[0_0_8px_rgba(167,157,218,0.8),0_0_16px_rgba(81,69,117,0.4)]",
